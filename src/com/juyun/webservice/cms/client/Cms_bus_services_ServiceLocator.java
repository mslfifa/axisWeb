...
public class Cms_bus_services_ServiceLocator extends org.apache.axis.client.Service implements com.juyun.webservice.cms.client.Cms_bus_services_Service {
    ...
    private java.lang.String cms_bus_servicesPort_address = "http://localhost:8080/axisWeb/services/cms_bus_servicesPort";
    ...
    public com.juyun.webservice.cms.client.Cms_bus_services_PortType getcms_bus_servicesPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.juyun.webservice.cms.client.Cms_bus_services_PortType getcms_bus_servicesPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.juyun.webservice.cms.client.Cms_bus_servicesPortSoapBindingStub _stub = new com.juyun.webservice.cms.client.Cms_bus_servicesPortSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.juyun.webservice.cms.client.Cms_bus_services_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.juyun.webservice.cms.client.Cms_bus_servicesPortSoapBindingStub _stub = new com.juyun.webservice.cms.client.Cms_bus_servicesPortSoapBindingStub(new java.net.URL(cms_bus_servicesPort_address), this);
                _stub.setPortName(getcms_bus_servicesPortWSDDServiceName());
                return _stub;
            }
        }
